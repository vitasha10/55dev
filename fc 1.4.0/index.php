    ...
    if(!isset($_COOKIE['userid'])){
        ...
        <div class='container'>
            ...
            <div class="content">
                ...
                //Чаты   
                if(isset($_POST["chat1"]) or isset($_POST["text"]) or isset($_GET['dell_sms']) or isset($_POST["sm1"]) or isset($_POST["sm2"]) or isset($_POST["sm3"]) or isset($_POST["sm4"]) or isset($_POST["sm5"]) or isset($_POST["sm6"]) or isset($_POST["sm7"]) or isset($_POST["sm8"]) or isset($_POST["sm9"])){
                    /*
                    <script>
                        function update() {
                            send_request('load');
...
Пипеец, когда-нибудь я научусь также. Всё-же Виталя обгоняет меня по кодингу, как ни прискорбно. Моя мотивация по сравнению с его - пустышка
