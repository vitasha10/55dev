...
<head>
    ...
    <style>
        header{
            ...
            background: -webkit-gradient(linear, 0 100%, 0 0, from(rgba(2,0,36,1)), color-stop(0.35, rgba(9,9,121,1)), to(rgba(0,212,255,1)));
            /*
        ...
        */
        ...
        main{
            width:100%;
            background: -webkit-gradient(linear, 0 100%, 0 0, from(rgba(0,212,255,1)), color-stop(0.35, rgba(9,9,121,1)), to(rgba(2,0,36,1)));
