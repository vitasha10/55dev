...
if(!isset($_COOKIE['userid'])){
    ...
    //запросы к бд
    $result = mysqli_fetch_array(mysqli_query($link, "SELECT `zadania` FROM `peoples` WHERE `userid`='{$_COOKIE['userid']}'"));
    ...
    <ul class='sidebar navbar-nav'>
        ...
        <li class='nav-item dropdown'>
            ...
            -->    
                ...
                <a class='dropdown-item active' href='my_task.php'>Мои задания</a>
            </div>
        </li>
        <!--
        <li class='nav-item'>
    ...
    <div id='content-wrapper'>
        <div class='container-fluid'>
            ...
            if($result["zadania"]!=""){
                ...
                echo "<h3>Мои задания:</h3><br/>".$result["zadania"]."<br>
                ";
            }else{
                echo "Заданий нет. <br>
                ";
